    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i=0; i < whereTo.size(); i++) {
            ...
            try {
                ...
                if (i == 0) {
                    //4th index is the 2nd resort on search results list
                    (hotelLinks.get(4)).click();
                    //wait 3 seconds
                    Thread.sleep(3000);
                }
                if (i == 1) {
                    //5th index is the 3rd resort on search results list
                    (hotelLinks.get(5)).click();
                    //wait 3 seconds
                    Thread.sleep(3000);
                }
                if (i == 2) {
            ...
            try {
                //capture hotel name
                ArrayList<WebElement> name = new ArrayList<>(driver.findElements(By.xpath("//*[@class = 'uitk-heading uitk-heading-3']")));
            ...
            //to separate each destination hotel
            System.out.println("**********************************************");
